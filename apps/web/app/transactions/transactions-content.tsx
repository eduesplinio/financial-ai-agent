...
export function TransactionsContent() {
  ...
  }, [session?.user, filters, page, limit]);
    ...
    <div className="space-y-6 w-full px-8 py-6">
      ...
      <div className="flex flex-wrap gap-4 mb-6 items-end">
        <div className="flex flex-wrap gap-2 w-full items-end justify-start">
          ...
          <div className="w-full sm:w-[150px]">
            <Select
              ...
              onValueChange={value => {
                ...
                setFilters(f => ({ ...f, period: value, startDate, endDate }));
                setPage(0);
              }}
            >
              <SelectTrigger className="w-full h-8">
          ...
          {/* Categoria - opção Todas (value="all") */}
            ...
            >
              {transactions.slice(0, 15).map(tx => {
                ...
                return (
                  <li
                    key={tx.id}
                    className="flex items-center py-3 px-4 w-full hover:bg-muted/30 transition"
                  >
