          ...
          <DropdownMenu>
            ...
            >
              <div className="py-1 px-0.5 border-b border-gray-300 dark:border-border/40">
                <Link
                  href="/profile"
                  className="flex items-center gap-2.5 px-3 py-2 rounded-md text-sm font-medium text-muted-foreground hover:text-primary no-underline hover:no-underline focus:no-underline active:no-underline hover:bg-muted/70 transition-colors"
                >
