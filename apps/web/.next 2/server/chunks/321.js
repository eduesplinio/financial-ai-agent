  ...
  (exports.modules = {
    ...
    81971: (e, t, r) => {
      ...
      class h {
        ...
        analyze() {
          var e, t, r, o, s;
          let l = (0, i.getNextPathnameInfo)(this[u].url.pathname, {
              nextConfig: this[u].options.nextConfig,
              parseData: !0,
              i18nProvider: this[u].options.i18nProvider,
            }),
            h = (0, a.getHostname)(this[u].url, this[u].options.headers);
          this[u].domainLocale = this[u].options.i18nProvider
            ? this[u].options.i18nProvider.detectDomainLocale(h)
      ...
      class d extends Response {
        ...
        static redirect(e, t) {
          ...
          return (
            ...
            new d(null, o(o({}, n), {}, { headers: a, status: r }))
          );
        }
        static rewrite(e, t) {
        ...
        if (e)
          for (let [o, a] of e.entries())
            'set-cookie' === o.toLowerCase()
              ? (r.push(...n(a)), (t[o] = 1 === r.length ? r[0] : r))
              : (t[o] = a);
        return t;
      }
      function a(e) {
    ...
    85212: (e, t, r) => {
      ...
      function i(e, t) {
        ...
        let {
          ...
          h = { pathname: e, trailingSlash: '/' !== e ? e.endsWith('/') : u };
        s &&
          (0, a.pathHasPrefix)(h.pathname, s) &&
          ((h.pathname = (0, o.removePathPrefix)(h.pathname, s)),
          (h.basePath = s));
        let d = h.pathname;
        if (
          ...
          ((h.buildId = r),
            ...
            !0 === t.parseData && (h.pathname = d));
        }
        if (l) {
          let e = t.i18nProvider
            ? t.i18nProvider.analyze(h.pathname)
            : (0, n.normalizeLocalePath)(h.pathname, l.locales);
          ((h.locale = e.detectedLocale),
            (h.pathname = null != (i = e.pathname) ? i : h.pathname),
            !e.detectedLocale &&
              h.buildId &&
              (e = t.i18nProvider
