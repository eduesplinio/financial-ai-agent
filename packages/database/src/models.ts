...
export const TransactionUpdateSchema = TransactionCreateSchema.partial().omit({
  userId: true,
});
...
export const KnowledgeDocumentUpdateSchema =
  KnowledgeDocumentCreateSchema.partial();
...
export const ConversationUpdateSchema = ConversationCreateSchema.partial().omit(
  { userId: true }
);
...
export class UserService {
  static async create(
    userData: z.infer<typeof UserCreateSchema>
  ): Promise<IUser> {
  ...
  static async update(
    id: string,
    updateData: z.infer<typeof UserUpdateSchema>
  ): Promise<IUser | null> {
...
export class TransactionService {
  static async create(
    transactionData: z.infer<typeof TransactionCreateSchema>
  ...
  static async update(
    id: string,
    updateData: z.infer<typeof TransactionUpdateSchema>
  ): Promise<ITransaction | null> {
    const validatedData = TransactionUpdateSchema.parse(updateData);
    return await Transaction.findByIdAndUpdate(id, validatedData, {
      new: true,
      runValidators: true,
    });
  }
...
export class KnowledgeDocumentService {
  static async create(
    docData: z.infer<typeof KnowledgeDocumentCreateSchema>
  ...
  static async update(
    id: string,
    updateData: z.infer<typeof KnowledgeDocumentUpdateSchema>
  ): Promise<IKnowledgeDocument | null> {
    const validatedData = KnowledgeDocumentUpdateSchema.parse(updateData);
    return await KnowledgeDocument.findByIdAndUpdate(id, validatedData, {
      new: true,
      runValidators: true,
    });
  }
...
export class ConversationService {
  static async create(
    conversationData: z.infer<typeof ConversationCreateSchema>
  ...
  static async findBySessionId(
    ...
    return await Conversation.findOne({ sessionId }).populate(
      'userId',
      'email profile'
    );
  }
